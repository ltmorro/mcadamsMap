...
class Model(object):
    def __init__(self):
        ...
        self.graph.add_node("116", neighbors={"115":1, "114":1})
        ...
        self.graph.add_node("118A", neighbors={"112":1, "118B":1, "118C":1, "118D":1, "122":1})
        ...
        self.graph.add_node("122", neighbors={"118A":1, "male_1_2":1, "124A":1, "123A":1})
        self.graph.add_node("124A", neighbors={"122":1, "124B":1, "125":1})
        self.graph.add_node("124B", neighbors={"124A":1, "female_1_2":1, "131":1})
        ...
        self.graph.add_node("123B", neighbors={"125":1, "123A":1, "122":1, "224":1})
        ...
        self.graph.add_node("201", neighbors={"109":1, "203":1})
        self.graph.add_node("203", neighbors={"201":1, "204":1})
        self.graph.add_node("204", neighbors={"203":1})
